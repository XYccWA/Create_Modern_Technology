...
public class ModFluidTypes {
    ...
    public static final ResourceLocation SOAP_OVERLAY_RL = new ResourceLocation(Create_modern_technology.MOD_ID, "misc/in_soap_water");

    // 获得deferredRegister的流体type的注册对象
    public static final DeferredRegister<FluidType> FLUID_TYPES =
            DeferredRegister.create(ForgeRegistries.Keys.FLUID_TYPES, Create_modern_technology.MOD_ID);
